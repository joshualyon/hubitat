 ...
 */
 ...
 //based on the original twack 3 beta driver

metadata {
	definition (name: "Fibaro RGBW", namespace: "hubitat", author: "Anonymouse") {
...
def configure() {
	log.debug "Configuring Fibaro RGBW"
...
def zwaveEvent(hubitat.zwave.commands.firmwareupdatemdv1.FirmwareMdReport cmd) { 
